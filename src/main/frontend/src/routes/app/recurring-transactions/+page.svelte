...
<div class="my-4 inline-flex w-full items-center">
	<h1 class="flex-grow text-2xl font-bold">Daueraufträge</h1>
	<a
		href="/app/recurring-transactions/create"
		title="Dauerauftrag Erstellen"
		...
		<table class="table-zebra table text-nowrap">
			...
			<tbody>
				{#each recurringTransactions! as recurringTransaction}
					<tr>
						...
						<td class="text-center">
							<a
								href="/app/recurring-transactions/edit/{recurringTransaction.id}"
								title="Dauerauftrag {recurringTransaction.id} bearbeiten"
				...
				{#if recurringTransactions?.length == 0}
					<tr>
						<td colspan="8" class="text-center text-lg"> Es gibt keine Daueraufträge. </td>
					</tr>
				{/if}
			</tbody>
		</table>
