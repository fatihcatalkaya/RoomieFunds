...
<div class="absolute h-screen w-screen inset-0 bg-base-100 z-100 flex flex-col transition-opacity transition-normal {$AuthStore.isAuthenticated ? "opacity-0 pointer-events-none" : "opacity-100"}">
