 ...
 * Start Authorization
 */
export const postApiTest = <ThrowOnError extends boolean = false>(options: Options<PostApiTestData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostApiTestResponse, unknown, ThrowOnError>({
        url: '/api/test',
        ...options,
        headers: {
            'Content-Type': 'application/json',
 ...
 * End Authorization
 */
export const getApiTestEnd = <ThrowOnError extends boolean = false>(options?: Options<GetApiTestEndData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<unknown, unknown, ThrowOnError>({
        url: '/api/test/end',
        ...options
    });
 ...
 * Get Stuff
 */
export const getApiTestStuff = <ThrowOnError extends boolean = false>(options?: Options<GetApiTestStuffData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetApiTestStuffResponse, unknown, ThrowOnError>({
        url: '/api/test/stuff',
        ...options
    });
};
