 ...
 * Synchronize Now
 */
export const getApiEnablebankingSynchronizeNow = <ThrowOnError extends boolean = false>(options?: Options<GetApiEnablebankingSynchronizeNowData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetApiEnablebankingSynchronizeNowResponse, unknown, ThrowOnError>({
