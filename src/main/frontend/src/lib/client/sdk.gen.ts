...
import type { GetData, GetApiAccountData, GetApiAccountResponse, PostApiAccountData, PostApiAccountResponse, GetApiAccountSendAccountStatementsNowData, DeleteApiAccountByAccountIdData, DeleteApiAccountByAccountIdResponse, GetApiAccountByAccountIdData, GetApiAccountByAccountIdResponse, PatchApiAccountByAccountIdData, PatchApiAccountByAccountIdResponse, GetApiAccountByAccountIdStatementData, GetApiAccountByAccountIdStatementResponse, GetApiEnablebankingData, GetApiEnablebankingResponse, PostApiEnablebankingData, PostApiEnablebankingResponse, GetApiEnablebankingEndData, GetApiEnablebankingSessionData, GetApiEnablebankingSessionResponse, GetApiEnablebankingSessionUnfinishedBySessionIdData, GetApiEnablebankingSessionUnfinishedBySessionIdResponse, PostApiEnablebankingSessionUnfinishedBySessionIdData, PostApiEnablebankingSessionUnfinishedBySessionIdResponse, DeleteApiEnablebankingUnfinishedSessionBySessionIdData, DeleteApiEnablebankingUnfinishedSessionBySessionIdResponse, GetApiFlurbeitragData, GetApiFlurbeitragResponse, PutApiFlurbeitragData, PutApiFlurbeitragResponse, GetApiFlurkontoData, GetApiFlurkontoResponse, PutApiFlurkontoData, PutApiFlurkontoResponse, GetApiLogData, GetApiLogResponse, GetApiLogAccountTransactionsByAccountIdData, GetApiLogAccountTransactionsByAccountIdResponse, GetApiLogByTableNameData, GetApiLogByTableNameResponse, GetApiLogByTableNameByObjectIdData, GetApiLogByTableNameByObjectIdResponse, GetApiPersonData, GetApiPersonResponse, PostApiPersonData, PostApiPersonResponse, DeleteApiPersonByPersonIdData, DeleteApiPersonByPersonIdResponse, GetApiPersonByPersonIdData, GetApiPersonByPersonIdResponse, PatchApiPersonByPersonIdData, PatchApiPersonByPersonIdResponse, GetApiProductData, GetApiProductResponse, PostApiProductData, PostApiProductResponse, GetApiProductTallylistData, GetApiProductTallylistResponse, DeleteApiProductByProductIdData, DeleteApiProductByProductIdResponse, GetApiProductByProductIdData, GetApiProductByProductIdResponse, PatchApiProductByProductIdData, PatchApiProductByProductIdResponse, GetApiRecurringTransactionData, GetApiRecurringTransactionResponse, PostApiRecurringTransactionData, PostApiRecurringTransactionResponse, DeleteApiRecurringTransactionByRecurringTransactionIdData, DeleteApiRecurringTransactionByRecurringTransactionIdResponse, GetApiRecurringTransactionByRecurringTransactionIdData, GetApiRecurringTransactionByRecurringTransactionIdResponse, PatchApiRecurringTransactionByRecurringTransactionIdData, PatchApiRecurringTransactionByRecurringTransactionIdResponse, PostApiTransactionData, PostApiTransactionResponse, GetApiTransactionAccountByAccountIdData, GetApiTransactionAccountByAccountIdResponse, DeleteApiTransactionByTransactionIdData, DeleteApiTransactionByTransactionIdResponse, GetApiTransactionByTransactionIdData, GetApiTransactionByTransactionIdResponse, PatchApiTransactionByTransactionIdData, PatchApiTransactionByTransactionIdResponse, DeleteApiTransactionByTransactionIdReceiptData, DeleteApiTransactionByTransactionIdReceiptResponse, GetApiTransactionByTransactionIdReceiptData, GetApiTransactionByTransactionIdReceiptResponse, PostApiTransactionByTransactionIdReceiptData, GetByFileNameData } from './types.gen';
...
export const getApiAccountByAccountIdStatement = <ThrowOnError extends boolean = false>(options: Options<GetApiAccountByAccountIdStatementData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetApiAccountByAccountIdStatementResponse, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const getApiEnablebanking = <ThrowOnError extends boolean = false>(options?: Options<GetApiEnablebankingData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetApiEnablebankingResponse, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const postApiEnablebanking = <ThrowOnError extends boolean = false>(options: Options<PostApiEnablebankingData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostApiEnablebankingResponse, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const getApiEnablebankingSession = <ThrowOnError extends boolean = false>(options?: Options<GetApiEnablebankingSessionData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetApiEnablebankingSessionResponse, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const getApiEnablebankingSessionUnfinishedBySessionId = <ThrowOnError extends boolean = false>(options: Options<GetApiEnablebankingSessionUnfinishedBySessionIdData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetApiEnablebankingSessionUnfinishedBySessionIdResponse, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const postApiEnablebankingSessionUnfinishedBySessionId = <ThrowOnError extends boolean = false>(options: Options<PostApiEnablebankingSessionUnfinishedBySessionIdData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostApiEnablebankingSessionUnfinishedBySessionIdResponse, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const deleteApiEnablebankingUnfinishedSessionBySessionId = <ThrowOnError extends boolean = false>(options: Options<DeleteApiEnablebankingUnfinishedSessionBySessionIdData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<DeleteApiEnablebankingUnfinishedSessionBySessionIdResponse, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const getApiLogAccountTransactionsByAccountId = <ThrowOnError extends boolean = false>(options: Options<GetApiLogAccountTransactionsByAccountIdData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetApiLogAccountTransactionsByAccountIdResponse, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const getApiLogByTableName = <ThrowOnError extends boolean = false>(options: Options<GetApiLogByTableNameData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetApiLogByTableNameResponse, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const getApiLogByTableNameByObjectId = <ThrowOnError extends boolean = false>(options: Options<GetApiLogByTableNameByObjectIdData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetApiLogByTableNameByObjectIdResponse, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const deleteApiTransactionByTransactionIdReceipt = <ThrowOnError extends boolean = false>(options: Options<DeleteApiTransactionByTransactionIdReceiptData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<DeleteApiTransactionByTransactionIdReceiptResponse, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const getApiTransactionByTransactionIdReceipt = <ThrowOnError extends boolean = false>(options: Options<GetApiTransactionByTransactionIdReceiptData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetApiTransactionByTransactionIdReceiptResponse, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
